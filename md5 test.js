...
const inputValue = (timeInSeconds * 100).toString();

console.log("Input Value for MD5:", inputValue);

// Calculate MD5 hash
var result = MD5(inputValue);
console.log("MD5 Hash:", result);

// Convert MD5 hash (hex string) to BigInt
// Prepend '0x' to the hex string for BigInt conversion
const hashAsBigInt = BigInt('0x' + result);
console.log("MD5 Hash as BigInt:", hashAsBigInt);
...
console.log("Normalized Hash Value (0-1):", normalizedValue);
